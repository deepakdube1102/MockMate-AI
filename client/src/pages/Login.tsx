...
import { Mail, Lock, Eye, EyeOff, TrendingUp, Target, Sparkles, LogIn } from 'lucide-react';
          ...
          <div className="space-y-5">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="pt-2">
                ...
                >
                  <LogIn className="w-5 h-5 shrink-0 group-hover:translate-x-0.5 transition-transform" />
                  <span>{submitting ? 'Signing in...' : 'Login to your account'}</span>
                </button>
              </div>
        ...
        <div className="w-[50vw] h-full bg-white flex flex-col justify-center p-16 relative overflow-y-auto">
          <div className="w-full max-w-[400px] mx-auto text-left">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-end pt-1">
                  <Link
                    to="/forgot-password"
                    className="text-xs font-bold text-violet-600 hover:text-violet-700 transition-colors hover:underline"
                  >
                    Forgot password?
                  </Link>
                </div>
            ...
            <div className="text-center mt-8">
              <span className="text-xs text-slate-400 font-bold">New to MockMate AI? </span>
              <Link to="/register" className="text-xs font-black text-violet-600 hover:text-violet-700 transition-colors">
                Create an account
              </Link>
            </div>
